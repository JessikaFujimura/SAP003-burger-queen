    ...
    <div className={css(styles.divmain)}>
      <section className={css(styles.menu)}>
        ...
        <article className={css(styles.menuItem)}>
          {menufilter.map((i) => <Menu item={i.item} icon={i.icon} value={i.value} option={i.option} add={i.add} handleClick={() => addItem(i)} />)}
        </article>
      </section>
      <section className={css(styles.commands)}>
        ...
        <article className={css(styles.commandsList)}>
          {order.map((i) => <List key={i.id} item={i.item} value={i.value} quant={i.quant} option={i.optionChange ? i.option : []} addition={i.addChange ? i.addChange : []} handleClick={() => deleteItem(i)} />)}
        </article>
